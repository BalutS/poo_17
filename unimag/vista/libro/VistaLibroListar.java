...
public class VistaLibroListar extends StackPane {
    ...
    private TableColumn<LibroDto, String> crearColumnaEditorial() {
        ...
        columna.setCellValueFactory(cellData -> {
            String editorial = cellData.getValue().getIdEditorial().getNombre();
            String pais = cellData.getValue().getIdEditorial().getPais();
    ...
    private TableColumn<LibroDto, String> crearColumnaAutor() {
        ...
        columna.setCellValueFactory(cellData -> {
            String autor = cellData.getValue().getIdAutor().getNombre();
            boolean esMasculino = cellData.getValue().getIdAutor().getGenero();
