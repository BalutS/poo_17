...
public class VistaPeliculaCrear extends StackPane {
    ...
    private void crearFormulario() {
        ...
        lblProtaPelicula.setFont(Font.font("Arial", FontPosture.ITALIC,
                TAMANIO_FUENTE));
        ...
        lblCodigoPelicula.setFont(Font.font("Arial", FontPosture.ITALIC,
                TAMANIO_FUENTE));
        miGrilla.add(lblCodigoPelicula, 0, 4);

        // ACA VIENE LO DEL COMBO
        ...
        ObservableList<GeneroDto> items
        ...
        lblEdadPelicula.setFont(Font.font("Arial", FontPosture.ITALIC,
                TAMANIO_FUENTE));
        ...
        lblPresupuestoPelicula.setFont(Font.font("Arial", FontPosture.ITALIC,
                TAMANIO_FUENTE));
    ...
    private GeneroDto obtenerGenero() {
        GeneroDto seleccionado = cbmGeneroPelicula.
    ...
    private void guardarPelicula() {
        if (formularioCompleto()) {
            ...
            dto.setIdGeneroPelicula(obtenerGenero());
