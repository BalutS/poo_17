...
public class LibroServicio implements ApiOperacionBD<LibroDto, Integer> {
  ...
  public List<LibroDto> selectFrom() {
    ...
    System.out.println("Filas leídas: " + arregloDatos.size());
    ...
    for (String cadena : arregloDatos) {
        try {
            ...
            if (columnas.length < 6) {
                System.err.println("Fila inválida: " + cadena);
                continue;
            }
            ...
            if (editorialDto == null || autorDto == null) {
                System.err.println("Editorial o Autor nulo para: " + cadena);
                continue;
            }
